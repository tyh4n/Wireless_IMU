...
public:
  ...
  void applySICmatrix(float factor0, float factor1, float factor2, float factor3, float factor4, float factor5,float factor6,float factor7,float factor8);
  void applySICmatrixFactor(adafruit_bno055_reg_t LSB_reg, adafruit_bno055_reg_t MSB_reg, float value);
