...
float Fz_est, Mx_est, My_est, Fz_est_old_0, Mx_est_old_0, My_est_old_0, Fz_est_old_1, Mx_est_old_1, My_est_old_1 = 0;
...
void loop() {
  ...
  Fz_est_old_1 = Fz_est_old_0;
  Mx_est_old_1 = Mx_est_old_0;
  My_est_old_1 = My_est_old_0;
  Fz_est_old_0 = Fz_est;
  Mx_est_old_0 = Mx_est;
  My_est_old_0 = My_est;
  ...
  FZ.f = (0.6*Fz_est) + (0.3*Fz_est_old_0) + (0.1*Fz_est_old_1);
  MX.f = (0.6*Mx_est) + (0.3*Mx_est_old_0) + (0.1*Mx_est_old_1); 
  MY.f = (0.6*My_est) + (0.3*My_est_old_0) + (0.1*My_est_old_1); 
  //switch
  ...
  nh.spinOnce();
  delay(1); // Wait for ROS spinOnce to finish
